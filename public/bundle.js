...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1),
	    Form = __webpack_require__(160),
	    Todo = __webpack_require__(161);
	...
	var Main = React.createClass({
		...
		handleNewTodo: function handleNewTodo(todo) {
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(Form, { onNewTodo: this.handleNewTodo }),
				React.createElement(
					'ul',
					null,
					this.state.todos.map(function (todo) {
						return React.createElement(Todo, { key: todo.id, task: todo.task, done: todo.done });
					})
				)
			);
		}
